		...
		<div class="home-intro mt-6 mb-6">
			<div class="container">
				<div class="home-intro__section">
					<h2 class="home-title">課程介紹</h2>
					<div class="row">
						<div class="col-md-6">
							<img
								src="https://hexschool-api.s3.us-west-2.amazonaws.com/custom/3ytBunIRdoAz3fj5pQHjXRks7kuYvdN9xEWs8djvoNuZ4aWCu4LaDhWvXgFtQtcVLuG06lUFY8GN8D0x2RbGbFXuhSlsHw2v1PC5xh7dfruIUpKwtg2n43Y3VvHY9UVK.jpg"
								alt="課程介紹"
								class="img-fluid"
							/>
						</div>
						<div class="col-md-6 m-auto home-intro__con">
							<p class="home-intro__text">
								...
								的課程相當完善，除了課程本身之外，我們在課前也提供身體評估跟身體組成分析，
				...
				<div class="home-intro__section">
					<h2 class="home-title">優質環境</h2>
					<div class="row flex-row-reverse justify-content-between mt-4">
						<div class="col-md-6">
							<img
								src="https://hexschool-api.s3.us-west-2.amazonaws.com/custom/eu6kMajvBAf3W9oF2JrRRkscOspho9jTJE6CAxI7WMyqr8qHsjuNPWclztO7VECD92grH2oL6HlP2ahFJibsT3JBWMw43mXHMlkE3S5bbbOy8Flk5hM5yxIXkll5Iury.jpg"
								alt="場館優質環境"
								class="img-fluid"
							/>
						</div>
				...
				<div class="row home-location__body">
					<div class="col-md-12 m-auto">
						...
						<p class="home-location__info">
							<i class="fas fa-map-marker-alt"></i> 地址：新北市土城區海山路18號
							(土城海山捷運站3號出口步行約3分鐘)
						</p>
						<iframe
							src="https://www.google.com/maps/embed?pb=!1m19!1m8!1m3!1d1808.1884050541146!2d121.449207!3d24.987309!3m2!1i1024!2i768!4f13.1!4m8!3e0!4m0!4m5!1s0x346802ca53d3d8fd%3A0x60fb81099c3ac0f4!2zMjM25paw5YyX5biC5Zyf5Z-O5Y2A5rW35bGx6LevMTjomZ8!3m2!1d24.987433799999998!2d121.4489887!5e0!3m2!1szh-TW!2stw!4v1599851824240!5m2!1szh-TW!2stw"
							width="800"
							height="400"
							frameborder="0"
							style="border: 0"
				...
				<div class="row">
					<div class="col-lg-4 col-md-6">
						<div class="card prod-card mb-4">
							<div class="prod-pic">
								<img
									src="https://hexschool-api.s3.us-west-2.amazonaws.com/custom/nVQ9LU5QRFu47UahUcp6FEz4msu4uFZxx9VT9Y2iQvqsUaXEd90Kmv6SqyI1rYcfkTdUfjl7cVqAnQxXeiMpE5R18svxsOS2qzK1MKd1NRi1FvoMiD8PsbFrVdSsDURm.jpg"
									alt="健身綜合"
									class="card-img-top"
								/>
							</div>
					...
					<div class="col-lg-4 col-md-6">
						<div class="card prod-card mb-4">
							<div class="prod-pic">
								<img
									src="https://hexschool-api.s3.us-west-2.amazonaws.com/custom/FgWWbyyhg0CDMz5y50k6WdgZyjFncKW4fOeJQCZfasnk7ZPGhX3teV1EbP031QrVhKw3gGmnUOX03YS6HMhvHs8b8nZrIlpJXpugAWPDFqS9F4Fp3acQGI4eenB75XC1.jpg"
									alt="初階瑜珈"
									class="card-img-top"
								/>
							</div>
							<div class="card-body prod-body text-left">
								<h4 class="mb-0">初階瑜珈</h4>
								<p class="text-muted mt-3 prod-content">
					...
					<div class="col-lg-4 col-md-6">
						<div class="card prod-card mb-4">
							<div class="prod-pic">
								<img
									src="https://hexschool-api.s3.us-west-2.amazonaws.com/custom/4WnO0OE58rGJW0bLsI0zHqfRLkAlCkDm1ZoToXOYwnvAJ4Rk1rI1s95QQHSkioGdsDCFAKpOIa0rGcvhoiaovHHVdbcDAap51ZoaVa0zRHGpZFg4iWzIkCZeWpAuHTmI.jpg"
									alt="燃脂飛輪"
									class="card-img-top"
								/>
							</div>
							<div class="card-body prod-body text-left">
								<h4 class="mb-0">燃脂飛輪</h4>
								<p class="text-muted mt-3 prod-content">
